...
from ops_wrapper import FusedLeakyReLU, fused_leaky_relu
...
class Blur(nn.Module):
    ...
    def forward(self, input):
        out = upfirdn2d(input, self.kernel, up=1, down=1, padding=self.pad)
...
class ToRGB(nn.Module):
    def __init__(self, in_channel, style_dim, upsample=True, blur_kernel=[1, 3, 3, 1]):
        ...
        #modify to greyscale despite the name
...
class Discriminator(nn.Module):
    def __init__(self, size, channel_multiplier=2, blur_kernel=[1, 3, 3, 1]):
        ...
        convs = [ConvLayer(1, channels[size], 1)]   #greyscale
...
class Encoder(nn.Module):
    def __init__(self, size, w_dim=512):
        ...
        convs = [ConvLayer(1, channels[size], 1)]  #one channel for grey
